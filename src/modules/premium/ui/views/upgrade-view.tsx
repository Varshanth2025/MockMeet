...
<div className="grid place-items-center">
  ...
  .filter(
    (product) =>
      ...
      product.metadata.badge === "Best Value"
  )
  .map((product) => {
                        ...
                        return (
                            <PricingCard key={product.id} buttonText={buttonText} onClick={onClick}
                            variant={product.metadata.variant === "highlighted" ?"highlighted":"default"}
                            title={product.name}
                            price={product.prices[0].amountType === "fixed" ?
                                product.prices[0].priceAmount/100:0
                            }
