    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-3">
                <FormComponents.FormField control={form.control} name="name" render={({field})=>(
                    <FormComponents.FormItem>
                        <FormComponents.FormLabel>Name</FormComponents.FormLabel>
            ...
            <div className="grid gap-3">
                <FormComponents.FormField control={form.control} name="email" render={({field})=>(
                    <FormComponents.FormItem>
                        <FormComponents.FormLabel>Email</FormComponents.FormLabel>
                        <FormComponents.FormControl>
             ...
             <div className="grid gap-3">
                <FormComponents.FormField control={form.control} name="password" render={({field})=>(
                    <FormComponents.FormItem>
            ...
            <div className="grid gap-3">
                <FormComponents.FormField control={form.control} name="confirmPassword" render={({field})=>(
                    <FormComponents.FormItem>
                        <FormComponents.FormLabel>Confirm Password</FormComponents.FormLabel>
                        <FormComponents.FormControl>
                            <Input type="password" placeholder="********" {...field}/>
                        </FormComponents.FormControl>
                        <FormComponents.FormMessage/>
...
<div className="grid grid-cols-2 gap-4">
    ...
    <div className="bg-radial from-sidebar-accent to-sidebar relative hidden md:flex flex-col gap-y-4  items-center justify-center ">
        <Image src="/logo.svg" alt="MockMeet Logo" className="h-[92px] w-[92px]" />
